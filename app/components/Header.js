                      ...
                      <div className="flex items-center justify-between header-content">
                          ...
                          >
                              <Link href="/">
                                  <Image
                                      ...
                                      width={100}
                                      height={40}
                                      className="max-w-[150px] lg:w-auto h-auto lg:max-w-[200px]"
                                  />
                              </Link>
                          </div>
                          <HeaderSearch
                          ...
                          <div className="flex items-center gap-4">
                              ...
                              <div className="relative lg:hidden">
                                  <button
                                      type="button"
                                      className="relative flex items-center justify-center gap-1 text-[22px] text-gray-800 border border-[#D14BF8] w-12 h-12 rounded-full bg-white z-[9999999]"
                                      onClick={handleSearch}
                                  >
                                      {showSearchModal ? (
                                          <RxCross1 />
